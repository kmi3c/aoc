...
test_array = input_array.product(input_array).map(&:sort).uniq
sum = test_array.find do |pair|
  pair[0] + pair[1] == 2020
end
puts "Part 1: #{sum[0] * sum[1]}"
#
# --- Part Two ---
#
# --- Part Two ---
...
#
test_array = input_array.product(test_array).map{|a| a.flatten.sort }.uniq
three = test_array.find do |t|
  t[0] + t[1] + t[2] == 2020
end
puts "Part 2: #{three.reduce(:*)}"
